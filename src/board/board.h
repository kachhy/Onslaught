...
public:
    ...
    struct BoardHistory {
        ...
        BoardHistory(
            ...
            BitBoard black_threats, BitBoard pinned, uint64_t zobrist_hash, uint64_t pawn_hash, Score material_pst_score
        ) :
...
private:
    ...
    // NNUE accumulator
    mutable Accumulator accumulator_stack[MAX_PLY + MAX_GAME_MOVES + 1];
    mutable int acc_ply = 0;
};
