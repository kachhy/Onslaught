...
inline void setBit(BitBoard& bitboard, int bit) { bitboard |= (BitBoard(1) << bit); }
inline void popBit(BitBoard& bitboard, int bit) { bitboard &= ~(BitBoard(1) << bit); }
inline void flipBit(BitBoard& bitboard, int bit) { bitboard ^= (BitBoard(1) << bit); }
inline void flipBits(BitBoard& bitboard, int bit_1, int bit_2) { bitboard ^= (BitBoard(1) << bit_1) | (BitBoard(1) << bit_2); }
